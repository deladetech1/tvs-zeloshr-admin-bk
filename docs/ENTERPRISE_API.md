...
| **Audit logs** | `GET /audit-logs/statistics` | `GET /audit-logs/list` · `GET /audit-logs/export` | `GET /audit-logs/get?audit_log_id=` | — (system) | — | `GET /audit-logs/purge/preview` · `DELETE /audit-logs/purge?retention_window=` (90/180/365 days) |
| **Platform users** | — | `GET /users/get-users` | — | — | — | — |
