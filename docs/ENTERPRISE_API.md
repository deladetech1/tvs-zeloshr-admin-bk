...
| **Audit logs** | `GET /audit-logs/statistics` | `GET /audit-logs/list` · `GET /audit-logs/export` | `GET /audit-logs/get?audit_log_id=` | — (system) | — | `DELETE /audit-logs/purge` (3‑month retention) |
