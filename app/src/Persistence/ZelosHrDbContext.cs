...
public sealed class ZelosHrDbContext(DbContextOptions<ZelosHrDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CpBusinessEntity>(b =>
        {
            b.ToTable("cp_businesses", "core_platform", t => t.ExcludeFromMigrations());
            b.HasKey(x => new { x.Id, x.TenantId });
            b.Property(x => x.BusName).HasColumnName("bus_name");
            b.Property(x => x.OrgId).HasColumnName("org_id");
        });
        ...
        modelBuilder.Entity<EmployeeIdFormatEntity>(b =>
        {
            b.ToTable("zhr_employee_id_format");
            b.HasKey(x => x.Id);
            b.Property(x => x.TenantId).HasMaxLength(128).IsRequired();
            b.Property(x => x.OrgId).HasMaxLength(128).IsRequired();
